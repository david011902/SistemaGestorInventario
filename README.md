...
**Frontend repo:** [Angular](https://github.com/david011902/sistema-inventario)
...
La pyme de leds manejaba su inventario de forma manual, lo que generaba 
pérdidas, descontrol de stock y falta de visibilidad sobre ventas y adquisiciones.

Este sistema centraliza la operación en una sola plataforma, permitiendo:
...
- Reducir pérdidas gracias al control de inventario por SKU
- Mejorar la experiencia hacia el cliente, teniendo una certeza sobre la disponibilidad de un producto
...
Los endpoints están implementados con **Minimal APIs** de .NET 8, organizados
...
La API expone una interfaz interactiva con **Scalar**
